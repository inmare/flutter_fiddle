...
class NativeAudioBindings {
  ...
  late final _soundtouch_createPtr =
      _lookup<ffi.NativeFunction<st_handle Function()>>('soundtouch_create');
  late final _soundtouch_create = _soundtouch_createPtr
      .asFunction<st_handle Function()>();
  ...
  void soundtouch_set_settings(
    ...
    return _soundtouch_set_settings(handle, sampleRate, channels, pitch, tempo);
  }
  ...
  void soundtouch_put_samples(
    ...
    return _soundtouch_put_samples(handle, samples, numSamples);
  }
  ...
  int soundtouch_receive_samples(
    ...
    return _soundtouch_receive_samples(handle, outputBuffer, maxSamples);
  }
  ...
  void soundtouch_destroy(st_handle handle) {
    return _soundtouch_destroy(handle);
  }

  late final _soundtouch_destroyPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(st_handle)>>(
        'soundtouch_destroy',
      );
